        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="relative group">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center rounded-lg">
              <h3 className="text-lg font-semibold text-black">Nettoyage Bureaux</h3>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            />
            <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center rounded-lg">
              <h3 className="text-lg font-semibold text-black">Entretien Régulier</h3>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            />
            <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center rounded-lg">
              <h3 className="text-lg font-semibold text-black">Nettoyage Spécial</h3>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            />
            <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center rounded-lg">
              <h3 className="text-lg font-semibold text-black">Service Écologique</h3>
            </div>
          </div>
        </div>
      </div>
