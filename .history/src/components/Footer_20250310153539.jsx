  ...
  return (
    ...
    <div className="flex ">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className= " w-full bg-white mt-10 border-t border-gray-600 pt-6 text-center">
          <p className="text-sm">
            <a href="/mentions-legales" className="hover:text-black">Mentions légales</a> |{" "}
            <a href="/conditions-confidentialite" className="hover:text-black">Conditions de confidentialité</a>
          </p>
