...
const Footer = () => {
  return (
    ...
    <div className="mt-2   py- ">
          <p className="text-sm">Mentions légales  Conditions de confidentialité @Bysouadou © 2024 NESSI Service. Tous droits réservés.
            <a href="/mentions-legales" className="hover:text-gray-300"></a> |{" "}
            <a href="/conditions-confidentialite" className="hover:text-gray-300"></a>
          </p>
