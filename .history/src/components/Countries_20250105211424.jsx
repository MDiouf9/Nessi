...
const Countries = () => {
  ...
  return (
    <div>
       ...
       <h1>Countries</h1> 
       <div className='  flex flex-c justify-center items-center'> 
 <div className='w-4/6 h-8 bg-blue-800 rounded-full flex' >
 ...
 {continent.map((count,index)=>(
    <input key={index} type="radio" value={count} onChange={HandleSelect} />
 ))}
 </div>
